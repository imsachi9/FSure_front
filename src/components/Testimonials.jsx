...
const Testimonials = ({ className = "" }) => {
  return (
    ...
    >
      <div className="flex-1 overflow-hidden flex flex-row items-start justify-center pt-[4.875rem] pb-[5.193rem] pl-[1.625rem] pr-[1.25rem] box-border bg-[url('/public/testimonials_bg.png')] bg-cover bg-no-repeat bg-[top] max-w-full mq750:pt-[3.188rem] mq750:pb-[3.375rem] mq750:box-border">
        <div className="w-[70.125rem] rounded-[30px] bg-[#f2f2f2] flex flex-col items-center justify-center p-[3.187rem] box-border gap-[1.912rem] max-w-full lg:pl-[1.563rem] lg:pr-[1.563rem] lg:box-border mq450:pt-[2.063rem] mq450:pb-[2.063rem] mq450:box-border mq750:gap-[0.938rem]">
          <div className="w-[32.988rem] flex flex-col items-center justify-start gap-[0.425rem] max-w-full shrink-0">
            <h2 className="m-[0px] w-[8.5rem] h-[1.875rem] relative text-inherit leading-[1.5rem] font-normal font-[inherit] flex items-center justify-center shrink-0 mq450:text-[1rem] mq450:leading-[1.188rem]">
              Client Testimonials
            </h2>
